...
async function fetchData() {
  const response = await fetch('https://api.https://api.origamid.dev/json/cursos.json.com/dados');
  const data: any = await response.json(); // aqui o uso do any é compreensível
